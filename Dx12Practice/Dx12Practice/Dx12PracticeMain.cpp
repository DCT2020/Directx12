#include "pch.h"
#include "Dx12PracticeMain.h"
#include "Common\DirectXHelper.h"

using namespace Dx12Practice;
...
Dx12PracticeMain::Dx12PracticeMain()
{
...
// 렌더러를 만들고 초기화합니다.
void Dx12PracticeMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void Dx12PracticeMain::OnWindowSizeChanged()
{
...
void Dx12PracticeMain::OnSuspending()
{
...
void Dx12PracticeMain::OnResuming()
{
	// TODO: 이것을 앱의 다시 시작 논리로 바꾸세요.
}

// 릴리스가 필요한 장치 리소스를 렌더러에 알립니다.
void Dx12PracticeMain::OnDeviceRemoved()
{
